                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group ">
                                    ...
                                    <input type="text"  class="form-control" name="emp_number" value="{{ $emp->emp_number }}">
                                  </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group ">
                                    ...
                                    <input type="date" value="{{ $emp->birth_date }}"  class="form-control" name="birth_date">
                                  </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group ">
                                    ...
                                    <input type="text"  class="form-control" name="contact" value="{{ $emp->contact }}">
                                  </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group ">
                                    ...
                                    <select class="form-control" name="wage_type">
                                        <option selected>{{ $emp->wage_type }}</option>
                                        <option disabled>&nbsp</option>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group ">
                                    ...
                                    <input type="text" class="form-control" name="rate" value="{{ $emp->rate }}"  onkeyup="c_format(this)">
                                  </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group ">
                                    ...
                                    <input type="text" class="form-control currency_format1" name="commida" value="{{ $emp->commida }}"  onkeyup="c_format(this)">
                                  </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group ">
                                    ...
                                    <input type="text" class="form-control currency_format1" name="transpo"  value="{{ $emp->transpo }}"  onkeyup="c_format(this)">
                                  </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group ">
                                    ...
                                    <input type="date"  class="form-control" name="date_hired" value="{{ $emp->date_hired }}">
                                  </div>
                            </div>
