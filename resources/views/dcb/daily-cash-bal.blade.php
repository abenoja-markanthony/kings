...
<div class="container mt-4">
    <div class="row justify-content-center">
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-6 text-right">
                            ...
                            <form action="{{ route('PDF-dcb') }}" method="GET">
                                @csrf
                            ...
                            <form action="{{ route('filter-dcb') }}" method="GET">
                                @csrf
                                <div class="col-lg-6">
        ...
        <form action="{{ route('store-dcb') }}" method="POST">
            @csrf
                    ...
                    <input type="hidden" name="ambaguio_tot_in" value="{{ $ambaguio_tot_in }}">
                    <input type="hidden" name="ambaguio_tot_out" value="{{ $ambaguio_tot_out }}">
                    <input type="hidden" name="ambaguio_exp" value="{{ $ambaguio_exp }}">
                    ...
                    <input type="hidden" name="bambang_tot_in" value="{{ $bambang_tot_in }}">
                    <input type="hidden" name="bambang_tot_out" value="{{ $bambang_tot_out }}">
                    <input type="hidden" name="bambang_exp" value="{{ $bambang_exp }}">
                    ...
                    <input type="hidden" name="dupax_norte_tot_in" value="{{ $dupax_norte_tot_in }}">
                    <input type="hidden" name="dupax_norte_tot_out" value="{{ $dupax_norte_tot_out }}">
                    <input type="hidden" name="dupax_norte_exp" value="{{ $dupax_norte_exp }}">

                    <input type="hidden" name="kayapa_tot_in" value="{{ $kayapa_tot_in }}">
                    <input type="hidden" name="kayapa_tot_out" value="{{ $kayapa_tot_out }}">
                    <input type="hidden" name="kayapa_exp" value="{{ $kayapa_exp }}">
                    ...
                    <input type="hidden" name="solano_tot_in" value="{{ $solano_tot_in }}">
                    <input type="hidden" name="solano_tot_out" value="{{ $solano_tot_out }}">
                    <input type="hidden" name="solano_exp" value="{{ $solano_exp }}">
