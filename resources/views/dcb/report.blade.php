        ...
        <div class="col-md-12">
            ...
            <div class="card p-4">
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-6 "><h3>DAILY RECEIPT AND DISBURSMENT REPORT</h3> <p class="text-primary"><b>CASH BALANCE :  {{ c($cashonhand) }}</b> </p>  </div>
                        <div class="col-lg-6 text-right">
                            ...
                            <form action="{{ route('review-dcb') }}" method="GET">
                                @csrf
                                <div class="col-lg-6">
                    ...
                    <table class="table table-bordered table-sm" id="tbl1">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ c(a($solano_tot_in)+a($solano_tot_cashin)-a($solano_tot_out)-a($solano_tot_others)) }}</td>
                                    <td>{{ c($solano_exp) }}</td>
                                    <td>{{ c(a($solano_tot_in)+a($solano_tot_cashin)-a($solano_exp)-a($solano_tot_out)-a($solano_tot_others)) }}</td>
                                </tr>
