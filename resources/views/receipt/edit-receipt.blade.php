        ...
        <div class="col-md-8">
            ...
            <div class="card p-4 mb-4">
                ...
                <div class="card-body ">
                    ...
                    <form action="{{ url('receipt/' . $rct->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-5">
                                <input type="date"  class="form-control1" name="r_date" value="{{ $rct->r_date }}" required>
                            </div>
                            <div class="form-group col-lg-5 ">
                                    <select class="form-control1" name="station" id="station" required >
                                        <option>{{ $rct->station }}</option>
                    ...
                    <div id="draw_div">
                        ...
                        <table class=" table-condensed table-bordered tbl1">
                            ...
                            <tbody>
                                <tr>
                                    <td>DRAW 1</td>
                                    <td><input type="text" class=" input1 text-right pr-2" name="draw1_in" id="draw1_in" onkeyup="c_format(this)" value="{{ c($rct->draw1_in) }}" required></td>
                                    <td><input type="text" class=" input1 text-right pr-2" name="draw1_out" id="draw1_out"  onkeyup="c_format(this)" value="{{ c($rct->draw1_out) }}" required></td>
                                </tr>

                                <tr>
                                    <td>DRAW 2</td>
                                    <td><input type="text" class="input1  text-right pr-2" name="draw2_in" id="draw2_in" onkeyup="c_format(this)" value="{{ c($rct->draw2_in) }}"></td>
                                    <td><input type="text" class="input1  text-right pr-2" name="draw2_out" id="draw2_out" onkeyup="c_format(this)" value="{{ c($rct->draw2_out) }}"></td>
                                </tr>

                                <tr>
                                    <td>DRAW 3</td>
                                    <td><input type="text" class="input1  text-right pr-2" name="draw3_in" id="draw3_in" onkeyup="c_format(this)" value="{{ c($rct->draw3_in) }}"></td>
                                    <td><input type="text" class=" input1  text-right pr-2" name="draw3_out" id="draw3_out" onkeyup="c_format(this)" value="{{ c($rct->draw3_out) }}"></td>
                                </tr>
                                <tr>
                                    <td></td>
                    ...
                    <table class="table-condensed table-bordered tbl1" id="add_others">
                        ...
                        <tbody>
                            <tr class='add_others'>
                                <td>1</td>
                                <td><input type="text" class="pl-2"  name="cash1_title" value="{{ $rct->cash1_title }}"></td>
                                <td><input type="text" class="input1  text-right pr-2" name="cash1_amt" id="cash1_amt" onkeyup="c_format(this)" value="{{ c($rct->cash1_amt) }}"></td>
                            </tr>
                            <tr class='add_others'>
                                <td>2</td>
                                <td><input type="text"  class="pl-2"  name="cash2_title" value="{{ $rct->cash2_title }}"></td>
                                <td><input type="text" class="input1  text-right pr-2" name="cash2_amt" id="cash2_amt" onkeyup="c_format(this)" value="{{ c($rct->cash2_amt) }}"></td>
                            </tr>
                    ...
                    <table class="table-condensed table-bordered tbl1" id="add_others">
                        ...
                        <tbody>
                            <tr class='add_others'>
                                <td>1</td>
                                <td><input type="text"  class="pl-2"  name="add1_title" value="{{ $rct->add1_title }}"></td>
                                <td><input type="text" class="input1  text-right pr-2" name="add1_amt" id="add1_amt" onkeyup="c_format(this)" value="{{ c($rct->add1_amt) }}"></td>
                            </tr>
                            <tr class='add_others'>
                                <td>2</td>
                                <td><input type="text"  class="pl-2"  name="add2_title" value="{{ $rct->add2_title }}"></td>
                                <td><input type="text" class="input1  text-right pr-2" name="add2_amt" id="add2_amt" onkeyup="c_format(this)" value="{{ c($rct->add2_amt) }}"></td>
                            </tr>
                            <tr class='add_others'>
                                <td>3</td>
                                <td><input type="text"  class="pl-2"  name="add3_title" value="{{ $rct->add3_title }}"></td>
                                <td><input type="text" class="input1  text-right pr-2" name="add3_amt" id="add3_amt" onkeyup="c_format(this)" value="{{ c($rct->add3_amt) }}"></td>
                            </tr>
                            <tr class='add_others'>
                                <td>4</td>
                                <td><input type="text"  class="pl-2"  name="add4_title" value="{{ $rct->add4_title }}"></td>
                                <td><input type="text" class="input1  text-right pr-2" name="add4_amt" id="add4_amt" onkeyup="c_format(this)" value="{{ c($rct->add4_amt) }}"></td>
                            </tr>
                            <tr class='add_others'>
                                <td>#</td>
                                <td></td>
                        ...
                        <div class="col-lg-12 mt-4 text-center">
                           <p> <i>Kindly double-check all the inputs before saving.Thank you.</i></p>
                            <input type="submit" value="UPDATE" class="btn btn-primary pl-4 pr-4 mt-1">
                        </div>
