        ...
        <div class="col-md-8">
            ...
            <div class="card p-4">
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-12 "><h3>PAYROLL </h3> </div>
                        <div class="col-lg-7">
                      ...
                      @endif
                        @foreach ($pay as $pays)
                            <tr style="height: 25px">
                                <td>{{ date('M. d, Y', strtotime($pays->period_from)) }} ~  {{ date('M. d, Y', strtotime($pays->period_to)) }}</td>
                                <td>
                                    <a href="{{ url('payroll/'.$pays->period_from.'/'.$pays->period_to.'/ALL') }}" class="sm-btn btn-success btn1">Update</a>
                                    <a href="{{ url('payroll-delete/'.$pays->period_from.'/'.$pays->period_to) }}" class="sm-btn btn-danger btn1"  onclick="return myFunction();">Delete</a>
                                </td>
                            </tr>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{ route('add-payroll-period') }}" method="POST">
                @csrf
...
<script>
    function myFunction() {
        if(!confirm("Are you sure to delete this payroll cutoff?"))
