        ...
        <div class="col-md-12">
            ...
            <div class="card p-4">
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-6 "><h3>DAILY SALES REPORT</h3> <p class="text-primary"></div>
                        <div class="col-lg-6 text-right">
                            <h3> {{ date('M. d, Y', strtotime($search_date)) }}</h3> 
                            <form action="{{ route('PDF-daily-report') }}" method="GET">
                                @csrf
...
{{-- 
        ...
        <form action="{{ route('accept-daily-report') }}" method="POST">
            @csrf
                    ...
                    <div class="col-lg-12 mt-4 text-center">
                        <p> <i>Kindly double-check all the data before accepting.Thank you.</i></p>
                         <input type="submit" value="SAVE" class="btn btn-primary pl-4 pr-4 mt-1">
                    </div>
