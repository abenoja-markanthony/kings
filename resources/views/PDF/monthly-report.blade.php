...
@endphp 
        <div id="h">
            <div id="top1">
                <img src="{{ asset('images/kings.png') }}" alt="Company Logo"  id="top3" class="logo" width="120px">
            </div>
            <div id="top2">
                <span>KING'S 810 GAMING CORPORATION</span>

            </div>
            <div id="top3">
                <p >NUEVA VIZCAYA - {{ $monthName." ".$year }}</p>
            </div>
        </div>
...
<table  id="dcb" >
    ...
    <tbody  id="body">
        ...
        <tr class="bottom">
            ...
            @endif
            <td>{{ c($f_fund_total-$la_flexible_fund) }}</td>
