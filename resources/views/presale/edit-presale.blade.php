        ...
        <div class="col-md-12">
            ...
            <div class="card p-4">
                ...
                <div class="card-body">
                    ...
                    <input type="text" id="tot_in" value="{{ $tot_in }}">
                    <input type="text" id="tot_out" value="{{ $tot_out }}">
                    <input type="text" id="net_sales" value="{{ $net_sales }}">
...
<script>
    $(document).ready(function(){
        $('.btnEdit').click(function(){
            ...
            $('#id1').val(data[8]);
            $('#EditSalesPre').attr('action','/daily-pre-sales/'+data[8]+'/update');
